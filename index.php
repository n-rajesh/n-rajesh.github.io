...
<html lang="en">
        ...
        <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring healthy and affordable food to all and save precious time spent in kitchen.">
        ...
        <header>
            <nav>
                <div class="row">
                    ...
                    <a class="mobile-nav js-mob-nav"><i class="ion-navicon-round"></i> </a>
                </div>
            </nav>
    ...
    <section class="section-features js-section" id="features">
        <div class="row"> 
    ...
    <section class="section-steps" id="steps">
        ...
        <div class="row">
            <div class="col span-1-of-2">
                <img src="resources/img/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen wp-2">
            </div>
            <div class="col span-1-of-2">
    ...
    <section class="section-plans" id="plans">
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <div class="plan-box wp-4">
                    <div>
                        <h3>Premium</h3>
                        <p class="plan-price">$399 <span class="part">/ month</span></p>
                        <p class="plan-price-meal">That's only $13.50 per meal </p>
                    </div>
                    <div>
                        <ul>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    <div>
                        <h3>Pro</h3>
                        <p class="plan-price">$149 <span class="part"> / month</span></p>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    <div>
                            <h3>Starter</h3>
                        <p class="plan-price">$19 <span class="part">/ meal </span></p>
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        <div class="row">
                            <?php
                                if($_GET['success'] == 1) {
                                    echo "<div class=\"form-messages success\">Your message has been sent.Thank you!</div>";
                                }                         
                                else {
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3"> 
                                <input type="submit" value="Send" id="sbtn">
                            </div>
                        </div>
    ...
    <!--[if (gte IE 6)&(lte IE 8)]>
	  <script type="text/javascript" src="vendors/js/selectivizr.js"></script>
